      ...
      <article className="mx-auto max-w-4xl px-4 md:px-8 py-12 md:py-16">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Our service is intended for students preparing for JEE examinations. While we do not specifically target children under 13, we recognize that some users may be minors. If you are under 18, please obtain parental consent before using our platform. Parents or guardians may contact us to review, modify, or delete their child's information.
            </p>
          </section>

          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-foreground">8. Third-Party Links and Services</h2>
            <p className="text-muted-foreground leading-relaxed">
              Our platform may contain links to third-party websites or integrate third-party services (e.g., Google AdSense for advertisements). We are not responsible for the privacy practices of these third parties. We encourage you to review their privacy policies before providing any personal information.
            </p>
          </section>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-foreground">12. Consent</h2>
            <p className="text-muted-foreground leading-relaxed">
