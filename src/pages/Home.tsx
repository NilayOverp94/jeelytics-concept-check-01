        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="card-jee animate-scale-in">
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-4 animate-fade-in">
                  ...
                  <Select value={selectedTopic} onValueChange={setSelectedTopic}>
                    ...
                    <SelectContent className="bg-popover border border-border">
                      <SelectItem value="All Topics" className="hover:bg-muted font-semibold text-primary">
                        ✓ All Topics (Full Chapter Test)
                      </SelectItem>
              ...
              {selectedSubject && selectedTopic && questionCount === 25 && (difficulty === 'jee-mains' || difficulty === 'jee-advanced') && (
